...
gulp.task('js', function () {
    return gulp.src(['node_modules/jquery/dist/jquery.min.js', 'node_modules/slick-carousel/slick/slick.min.js', 'node_modules/bootstrap/dist/js/bootstrap.js', 'app/js/script.js'])
        .pipe(concat('all.js'))
        .pipe(babel({
            presets: ['@babel/env']
        }))
